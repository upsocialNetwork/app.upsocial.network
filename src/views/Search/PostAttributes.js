        ...
        <>
            <div className="post-crud-wrap max-520 d-flex justify-content-between">
                <ul className="p-curd-left">
                    <li><button className="action-type-one"><span className="like"><i className="fal fa-arrow-alt-up"></i></span>{/* {element.likes} */}200</button></li>
                    <li><button className="action-type-one"><span className="unlike"><i className="fal fa-arrow-alt-down"></i></span>{/* {element.dislikes} */}200</button></li>
                </ul>
                <ul className="p-curd-right">
                    <li><button data-bs-toggle="collapse" data-bs-target={"#comment-"+"200"}><img src="img/sms.svg" alt="" /></button></li>
            ...
            <form className="post-coment-form max-520 collapse" id={"comment-"+"200"}>
